...
-- ----------------------------
-- Table structure for `t_policy_hn`
-- ----------------------------
DROP TABLE IF EXISTS `t_policy_hn`;
...
-- ----------------------------
-- Auto increment value for `t_policy_hn`
-- ----------------------------
'''
...
for file in os.listdir("Json"):
    ...
    a.get_attachment("Atta/", "/Attachments/Hunan/20161213/")
    a.save_sql("t_policy_hn")
...
with open ("Hunan-sql.sql", 'w', encoding="utf8") as f:
    f.write(beginstr)
    f.writelines(d)