...
-- ----------------------------
-- Table structure for `t_policy_jx`
-- ----------------------------
DROP TABLE IF EXISTS `t_policy_jx`;
CREATE TABLE `t_policy_jx` (
...
-- ----------------------------
-- Auto increment value for `t_policy_jx`
-- ----------------------------
'''
...
for file in os.listdir("Json"):
    ...
    a.get_attachment("Atta/", "/Attachments/Jiangxi/20170105/")
    a.save_sql("t_policy_jx")
...
with open ("Jiangxi-sql.sql", 'w', encoding="utf8") as f:
    f.write(beginstr)
    f.writelines(d)