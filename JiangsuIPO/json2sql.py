...
-- ----------------------------
-- Table structure for `t_policy_js`
-- ----------------------------
DROP TABLE IF EXISTS `t_policy_js`;
CREATE TABLE `t_policy_js` (
...
-- ----------------------------
-- Auto increment value for `t_policy_js`
-- ----------------------------
'''
...
for file in os.listdir("Json"):
    ...
    a.get_attachment("Atta/", "/Attachments/Jiangsu/20161218/")
    a.save_sql("t_policy_js")
...
with open ("Jiangsu-sql.sql", 'w', encoding="utf8") as f:
    f.write(beginstr)
    f.writelines(d)